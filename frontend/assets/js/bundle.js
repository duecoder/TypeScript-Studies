...
/***/ "./src/a19-exercicio/form-control.ts":
/*!*******************************************!*\
  !*** ./src/a19-exercicio/form-control.ts ***!
  \*******************************************/
...
function checkEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessage(input, `O campo '${input.name}' deve ser preenchido.`);
    });
}
...
/*!************************************!*\
  !*** ./src/a19-exercicio/index.ts ***!
  \************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/a19-exercicio/form-control.ts");
